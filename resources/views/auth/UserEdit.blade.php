    ...
    <div class="abc">
        <form action="/updateUser" method="POST" class="p-4 rounded shadow bg-white" style="width: 100%; max-width: 500px;">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input name="name" type="text" class="form-control" id="specificSizeInputName" placeholder="A.B.C.Perera" value="{{$data['name']}}" required>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input name="age" type="text" class="form-control" id="specificSizeInputName" placeholder="E.g:35" value="{{$data['age']}}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input name="telNo" type="text" class="form-control" id="specificSizeInputTelNo" placeholder="07x1234567" value="{{$data['telNo']}}" required>
                    <span class="text-danger">
                        @error('telNo')
                            <br>                          
                            <div class="alert alert-danger" style="text-align:center;" >
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input name="email" type="email" class="form-control" id="specificSizeInputEmail" placeholder="perera@ruh.ac.lk" value="{{$data['email']}}" required>
                    <span class="text-danger">
                        @error('email')
                            <br>                          
                            <div class="alert alert-danger" style="text-align:center;" >
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <input name="nic" type="text" class="form-control" id="specificSizeInputNic" placeholder="909090909V" value="{{$data['nic']}}" required>
                    <span class="text-danger">
                        @error('nic')
                            <br>                          
                            <div class="alert alert-danger" style="text-align:center;" >
            ...
            <div class="mb-3 row d-none" id="SLMCField">
                ...
                <div class="col-sm-8">
                    <input name="slmcNo" type="text" class="form-control" id="specificSizeInputSLMC" value="{{$data['slmcNo']}}">
                </div>
            </div>
